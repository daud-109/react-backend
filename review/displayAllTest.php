<?php
//this file will display all of the business to select
//from to see the review
...
if (mysqli_stmt_execute($stmt)) {
  ...
  //if that json is empty then display all of the business
  require "./displayAllBusiness.php";
}
